...
local NHS_HOW_TO_PLAY_SECTIONS = {
  {
    ...
    body = table.concat({
      ...
      "• Normal Plus: like normal, but every 10 seconds the closest player to the seeker will do an audible emote. Also, once there is one hider left, they will be pinged.",
      "• Hot and Cold: the seeker gets hot and cold information on how close they are to a hider. The search times are halved.",
      "• Paired: the seeker is paired with another seeker. The search times are halved.",
      "• Conquer: as the seeker finds players, those players become seekers. The search times are halved.",
      "• Chosen One: one hider, the rest are seekers. The search times are halved.",
      "• Lightning: hiders only get 30 seconds to hide. The search times are halved.",
    }, "\n"),
  },
}
